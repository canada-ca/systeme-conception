...
<div id="expand-collapse">
    ...
    <p>Mise à jour du <a href="{{ site.url }}styles/typographie.html">configuration &laquo;&nbsp;Signaler un problème sur cette page&nbsp;&raquo;</a> pour inclure les spécifications de conception relatives au nouveau style du titre principal des pages (H1).</p>
  </details>
  <details>
