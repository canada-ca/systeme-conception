...
**Analyse manuelle**  
: Petits ensembles de données, examen détaillé et validation des constats.

**Analyse assistée par l’IA**  
: Grands ensembles de données, repérage rapide des thèmes et rédaction de résumés.

**Approche combinée**  
: La plupart des cas d’utilisation opérationnels; l’IA appuie l’analyse tandis que les humains valident les constats.
