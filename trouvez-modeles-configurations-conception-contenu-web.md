  ...
  <form method="get">
    ...
    <div id="question-2" class="hidden wb-fieldflow-sub" data-wb-fieldflow="{&quot;renderas&quot;:&quot;radio&quot;}">
      ...
      <ul>
        ...
        <li data-wb-fieldflow="{&quot;action&quot;: &quot;removeClass&quot;, &quot;class&quot;: &quot;hidden&quot;, &quot;source&quot;: &quot;#result31&quot;}">Avertissement ou déclaration sur la confidentialité </li>
        ...
        <div class="panel-body">
          ...
          <table class="wb-tables table table-striped table-hover small" data-wb-tables="{ &quot;ordering&quot; : false , &quot;paging&quot; : false }">
            ...
            <tbody>
              ...
              <tr>
                <td><span lang="en">Canadian Grain Commission</span></td>
              ...
              <tr>
                ...
                <td>Recherche et développement pour la Défense Canada</td>
                <td>Organisme de services spéciaux </td>
              ...
              <tr>
                ...
                <td>Surveillance environnementale des sables bitumineux Canada-Alberta</td>
                <td>Aucune structure institutionnelle</td>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
                <td><a href="{{ site.url }}/modeles-recommandes/profil-partenariat-entente-collaboration.html">Profil d’entente de partenariat ou de collaboration</a></td>
              ...
              <tr>
                <td><span lang="en">Wild Species</span></td>
                <td>Espèces sauvages</td>
                <td>Aucune structure institutionnelle</td>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
                <td><a href="{{ site.url }}/modeles-recommandes/profil-partenariat-entente-collaboration.html">Profil d’entente de partenariat ou de collaboration</a></td>
              ...
              <tr>
                <td><span lang="en">Genomics Research and Defence Initiative</span></td>
                <td>Initiative de Recherche et développement en génomique</td>
                <td>Aucune structure institutionnelle</td>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
                <td><a href="{{ site.url }}/modeles-recommandes/profil-partenariat-entente-collaboration.html">Profil d’entente de partenariat ou de collaboration</a></td>
    ...
    <div id="result14" class="hidden">
      <section class="panel panel-primary">
        <header class="panel-heading">
          <h2 class="panel-title">Faites une recherche pour votre institution</h2>
        </header>
        <div class="panel-body">
          <p>Faites une recherche dans la liste suivante pour trouver quel profil vous devriez utiliser.</p>
          <table class="wb-tables table table-striped table-hover small" data-wb-tables="{ &quot;ordering&quot; : false , &quot;paging&quot; : false }">
            <thead>
              <tr class="active">
                <th scope="col"><span lang="en">Display name</span></th>
    ...
    <div id="result22" class="hidden">
      <section class="panel panel-primary">
        <header class="panel-heading">
          <h2 class="panel-title">Pages connexes </h2>
        </header>
        <div class="panel-body">
    ...
    <div id="result25" class="hidden">
      <section class="panel panel-primary">
        <header class="panel-heading">
          <h2 class="panel-title">Configurations visuelles </h2>
        </header>
        <div class="panel-body">
    ...
    <div id="result34" class="hidden">
      <section class="panel panel-primary">
        <header class="panel-heading">
          <h2 class="panel-title">Renseignements sur les médias sociaux</h2>
        </header>
        <div class="panel-body">
    ...
    <section class="panel panel-default">
      <header class="panel-heading">
        <h2 class="panel-title">Rétroaction, questions et suggestions</h2>
      </header>
      <div class="panel-body">
        ...
        <ul>
          ...
          <li>suggérer un changement mis à l’essai par des utilisateurs aux modèles et aux configuration</li>
          <li>contribuer une configuration ou un modèle manquant</li>
        </ul>
      </div>
    </section>
  </form>
