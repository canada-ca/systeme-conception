...
<div class="pattern-demo mrgn-tp-lg">
  <figure class="mrgn-bttm-sm"><img src="../images/01-breadcrumbs-main-fr.png" class="img-responsive" alt="">
  </figure>
</div>
...
<p>Vous pouvez utiliser «&nbsp;Accueil&nbsp;» ou le nom du processus ou de l’application comme texte du premier lien du fil d’Ariane sur les pages transactionnelles qui utilisent un fil d’Ariane.</p>
<ul>
...
<h4>Accessibilité</h4>
<ul>
  <li>Incluez le texte d’aide invisible «&nbsp;Vous êtes ici&nbsp;:&nbsp;».</li>
</ul>
