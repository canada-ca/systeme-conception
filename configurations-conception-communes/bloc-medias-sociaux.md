        ...
        <table class="table table-striped" id="social-media" aria-live="polite">
          ...
          <tbody>
            <tr>
              <td>Facebook</td>
              <td><p>facebook</p></td>
              <td class="text-center gc-followus"><a href="https://github.com/wet-boew/GCWeb/blob/master/components/gc-follow-us/assets/facebook.svg" class="facebook wb-lbx"><span class="wb-inv">Facebook</span></a></td>
            </tr>
            <tr>
              <td>Twitter</td>
              <td><p>twitter</p></td>
