...
<ul>
  <li>les produits recherchés par les acheteurs</li>
...
<details>
  ...
  <p>La hiérarchie du code est indiquée dans un encadré de couleur&nbsp;: </p>
  <ul>
    <li>Codes de catégorie (UNSPSC)</li>
    <li>Services (segments 70-94)</li>
    <li>Technologie, recherche et ingénierie – 81000000</li>
    <li>Services informatiques – 81110000</li>
    <li>Ingénierie logicielle ou matérielle – 81115000</li>
    <li>Services de développement d'applications clients Internet ou intranet - 81111509</li>
  </ul>
</details>
      ...
      <table class="table table-bordered">
        <thead>
          <tr>
            ...
            <th scope="col">Trouvabilité</th>
          </tr>
        </thead>
        <tbody>
          <tr>
            <td>Appel d'offres (aménagement paysager)</td>
            <td>11&nbsp;%</td>
            <td>58&nbsp;%</td>
          </tr>
          <tr>
            <td>Joignez-vous à la Liste des fournisseurs intéressés</td>
            <td>39&nbsp;%</td>
            <td>79&nbsp;%</td>
          </tr>
          <tr>
            <td>Énoncé des travaux</td>
            <td>6&nbsp;%</td>
            <td>79&nbsp;%</td>
          </tr>
          <tr>
          ...
          <tr>
            <td>Recherche dans le NIBS</td>
            <td>29&nbsp;%</td>
            <td>47&nbsp;%</td>
          </tr>
          <tr>
            <td>Arrangement en matière d'approvisionnement</td>
            <td>22&nbsp;%</td>
            <td>47&nbsp;%</td>
          </tr>
        </tbody>
