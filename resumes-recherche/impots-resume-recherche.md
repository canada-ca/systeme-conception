...
<figure> <img class="img-responsive" alt="Saisie d’écran Web montrant la page «&nbsp;Comment et quand faire les versements de retenues à la source&nbsp;» avant et après le remaniement. La description détaillée suit." src="../images/taxes-impots/beforeafter-sourcedeductions-FR.jpg"/>
...
<div> <img class="img-responsive hidden-sm hidden-xs" alt="Diagramme à barres de comparaison des taux de réussite des tâches sur le site existant (initial) et le prototype remanié (validation) pour les six tâches. Les données pour chaque tâche se trouvent dans le tableau ci-dessous. Le graphique indique que les participants ont eu un taux de succès supérieur pour toutes les tâches lors des tests de validation." src="../images/taxes-impots/CRA-TF-task-success-chart-FR.jpg"/></div>
