...
description: null
title: " Pages de directives sur les lois - Mod\xE8le de Canada.ca"
---
...
<div>
  ...
  <ul>
   ...
   <li>
    ...
    <ul>
     <li>
      <a href="#recherche">
       Page de recherche de directive sur les lois
      </a>
     </li>
     <li>
      <a href="#profil">
       Page de profil de directive sur les lois
      </a>
     </li>
     <li>
      <a href="#historique">
       Page d’historique de la directive
      </a>
     </li>
    </ul>
   </li>
        ...
        <li id="element1-1">
         <details class="mrgn-bttm-sm">
          ...
          <ul>
           <li>
            Allez à la
            <a href="./pages-index.html#filtre">
        ...
        <li id="element1-7">
         <details class="mrgn-bttm-sm">
          ...
          <ul>
           ...
           <li>
            Les grands ensembles d’entrées sont divisés en pages de dix entrées chacune, à l’aide des contrôles de pagination normalisés de la
         ...
         <details class="mrgn-bttm-sm">
          ...
          <ul>
           <li>
            ...
            <a href="../configurations-conception-communes/alertes-contextuelles.html">
 ...
 <nav class="mrgn-bttm-lg" role="navigation">
  ...
  <ul class="pager">
   <li class="previous">
    <a href="https://www.canada.ca/fr/secretariat-conseil-tresor/services/communications-gouvernementales/specifications-contenu-architecture-information-canada/modeles-specifications-detailles/pages-lois-reglements.html" rel="prev">
     Précédent
     <span class="wb-inv">
      : Pages des lois et des règlements de Canada.ca
     </span>
    </a>
   </li>
   <li class="toc">
   ...
   <li class="next">
    <a href="https://www.canada.ca/fr/secretariat-conseil-tresor/services/communications-gouvernementales/specifications-contenu-architecture-information-canada/modeles-specifications-detailles/pages-publics-cibles.html" rel="next">
     Suivant
     <span class="wb-inv">
      : Pages des publics cibles de Canada.ca
     </span>
    </a>
   </li>
  </ul>
